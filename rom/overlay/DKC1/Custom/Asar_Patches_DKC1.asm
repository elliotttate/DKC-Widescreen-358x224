...
; Note: Put your custom routine/data macros, references to them, and defines in this file from within the DKC1_InsertIntegratedPatches and DKC1_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro DKC1_InsertIntegratedPatches()
...
macro DKC1_ApplyPatchesPostAssembly()
...
; Anything in this macro will only be applied if !Define_Global_ApplyAsarPatches is set to !TRUE.
	...
	if defined("Define_DKC1_MSU1Restoration")
		incsrc "Patches/MSU1_Restoration.asm"
	endif
endmacro

;---------------------------------------------------------------------------

macro DKC1_HandleDefaultPatches()
