...
namespace DKCLevelAutomation
{
    internal static class Reflect
    {
        ...
        {
            if (instance == null) throw new NullReferenceException("Cannot call " + method + " on a null instance.");
        ...
        public static bool BoolCall(object instance, string method, bool fallback = false)
        {
            try { return Convert.ToBoolean(Call(instance, method), CultureInfo.InvariantCulture); }
            catch { return fallback; }
        }
