...
v0.4.16 retains compatibility with both the earlier ROM hashes and the
section-controller-fixed v1.1.2 ROM hashes. v0.4.15 (IL2CPP v0.1.10) completed
the optional 398x224 intro handling. The
